...
public sealed class WorldJsonDocumentServiceTests
{
    ...
    {
        var directory = Directory.CreateTempSubdirectory("nurcade-world-json-");
        ...
        try {
            ...
            Assert.AreEqual("nurcade.world", loaded.Document!.Format);
    ...
    {
        var directory = Directory.CreateTempSubdirectory("nurcade-layer-transition-");
