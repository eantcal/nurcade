...
public sealed class WeaponMetadataLoaderTests
{
    ...
    public void SaveRoundTripPreservesWeaponMetadata()
    {
        ...
        var targetDirectory = Directory.CreateTempSubdirectory("winraycast-weapon-metadata-");
    ...
    {
        var directory = Directory.CreateTempSubdirectory("winraycast-weapon-missing-");
