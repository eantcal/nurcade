...
public sealed class MainWindowViewModel : INotifyPropertyChanged
{
    ...
    public string Title => "WinRaycastEditor";
    ...
    {
        var dialog = new OpenFileDialog {
            Title = "Open WinRayCast world JSON",
            Filter = "WinRayCast world JSON|*.world.json;*.json|All files|*.*",
            CheckFileExists = true
        };
    ...
    {
        var dialog = new OpenFileDialog {
            Title = "Open WinRayCast sprite metadata",
    ...
    private void SaveSpriteMetadataAs()
    {
        ...
        var dialog = new SaveFileDialog {
            Title = "Save WinRayCast sprite metadata",
    ...
    {
        var dialog = new OpenFileDialog {
            Title = "Open WinRayCast project",
            Filter = "WinRayCast project|*.winrayproj.json;*.json|All files|*.*",
            CheckFileExists = true
        };
    ...
    private void SaveProjectAs()
    {
        ...
        var dialog = new SaveFileDialog {
            Title = "Save WinRayCast project",
            Filter = "WinRayCast project|*.winrayproj.json|All files|*.*",
            FileName = "project.winrayproj.json",
            AddExtension = true,
            OverwritePrompt = true
        };
    ...
    private void ExportScene()
    {
        ...
        if (enginePath is null) {
            MessageBox.Show(
                "Could not locate WinRayCastPlayer.exe. Build the C++ player first, then try again.",
        ...
        var dialog = new SaveFileDialog {
            Title = "Export playable WinRayCast demo package",
            Filter = "WinRayCast project|*.winrayproj.json|All files|*.*",
            FileName = "playable_demo.winrayproj.json",
            AddExtension = true,
            OverwritePrompt = true
        };
    ...
    private void TestIn3D()
    {
        ...
        try {
            ...
            var projectPath = Path.Combine(previewDirectory, "preview.winrayproj.json");
    ...
    private static void ShowAbout()
    {
        ...
        MessageBox.Show(
            "WinRaycast Editor\n"
            + $"Version {version}\n\n"
            + "Authoring tool for WinRayCast worlds, blocks, sprites, weapons, and playable previews.\n\n"
            + "Copyright (C) 2005 - 2018 Antonino Calderone\n"
            + "Licensed under the MIT License.\n\n"
            + $"Install path:\n{AppContext.BaseDirectory}",
            "About WinRaycast Editor",
            MessageBoxButton.OK,
            MessageBoxImage.Information);
    }
    ...
    private bool SaveWorldJsonAs()
    {
        ...
        var dialog = new SaveFileDialog {
            Title = "Save WinRayCast world JSON",
            Filter = "WinRayCast world JSON|*.world.json|All files|*.*",
