...
private:
    ...
    using DirectDrawPtr = std::unique_ptr<IDirectDraw7, ComReleaser<IDirectDraw7>>;
    using DirectDrawSurfacePtr =
        std::unique_ptr<IDirectDrawSurface7, ComReleaser<IDirectDrawSurface7>>;
